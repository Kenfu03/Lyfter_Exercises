...
def find_pokemon_by_type(pokemon_list : list[dict], type_to_find : str):
    pokemon_names : list[str] = []
    for pokemon in pokemon_list:
        pokemon_type : str = pokemon.get("type")
        pokemon_name : str = pokemon.get("name")
        if pokemon_type.lower() == type_to_find.lower():
...
if __name__ == "__main__":
    try:
        ...
        pokemon_names = find_pokemon_by_type(read_json(), type_to_find)
